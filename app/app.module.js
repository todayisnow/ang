...
var routes = [
    { path: 'heroes', component: my_heroes_component_1.HeroesComponent },
...
AppModule = __decorate([
    core_1.NgModule({
        imports: [platform_browser_1.BrowserModule, forms_1.FormsModule, http_1.HttpModule, router_1.RouterModule.forRoot(routes, { useHash: true })],
        declarations: [app_component_1.AppComponent, hero_detail_component_1.HeroDetailComponent, my_heroes_component_1.HeroesComponent, dashboard_component_1.DashboardComponent,
